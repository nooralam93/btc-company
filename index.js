...
// btc-company-firebase-adminsdk.json 

const serviceAccount = require('./btc-company-firebase-adminsdk.json');
...
async function run() {
    try {
        ...
        app.get('/showrooms', verifyToken, async (req, res) => {
        ...
        app.put('/users/admin', verifyToken, async (req, res) => {
            ...
            if (requester) {
                ...
                res.status(403).json({ message: 'you do not access make a admin' })
            }
